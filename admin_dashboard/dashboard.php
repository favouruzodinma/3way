                            ...
                            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
                                <div class="media media-card align-items-center">
                                    <div class="media-body">
                                        <h2 class="section__title fs-30">Welcome <?php echo $row ['fname' ] ?></h2>
                                        <div class="rating-wrap d-flex align-items-center pt-2">
                                            ...
                                            <span class="rating-total pl-1"><?php echo $row ['status'] ?></span>
                                        </div><!-- end rating-wrap -->
                                    </div><!-- end media-body -->
                                </div><!-- end media -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Total States</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Verified Users</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Unverified Users</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Total Users</p>
