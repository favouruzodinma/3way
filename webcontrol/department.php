        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
             ...
             <div class="breadcrumb-item">Manage Department</div>
            </div>
          </div>
          <div class="section-body">
            ...
            <div class="row">
              ...
              <a href="#" class="btn btn-primary pull-right mb-3"  data-toggle="modal" data-target=".faculty">Add Department</a>
...
<td><?php echo $row['faculty']; ?></td>
                          ...
                          <td><?php echo substr(remove_tags($row['requirement']),0,200); ?>...</td>
...
<a class="dropdown-item fillz" href="#"  data-toggle="modal" data-target=".edit<?php echo $row['dep_id']; ?>"  >Edit</a>
...
while($rows = $dpt->fetch_assoc()){ ?>
							?>
          <!-- modals -->
      <div class="modal fade edit<?php echo $rows['dep_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <form action="department_add.php" method="post" enctype="multipart/form-data">
