        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Branch Offices </h3>
                    <p class="info_text">Taiwan, Korea, China, Australia, Canada, Belgium, Brazil, France, Switzerland, Germany, Sweden.
                </p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">3waycourierservice@gmail.com</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">(305) 563 3497</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
        <div class="row align-items-center pt-30px">
            <div class="col-lg-7">
                <div class="contact-content pb-5">
                    <div class="section-heading">
                        <h2 class="section__title pb-3">YOUR INQUIRY</h2>
                        <p class="section__desc" style="font-size:16px">We value your inquires and feedback. Select an inquiry request from the list and complete the form below to send us a message and we would get back to you shortly afterwards.</p>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" action="#" class="contact-form">
                            ...
                            <div class="input-box">
                                <label class="label-text">Your Request</label>
                                <div class="form-group">
                                    <select id="request" class="form-control form--control" type="text" name="request" placeholder="Your name">
                                        <option value="">i need an offer for contract logistics</option>
                                        <option value="">i need an offer for air frieght</option>
                                        <option value="">i want to become a partner</option>
                                        <option value="">i have some other request</option>
                                    </select>
