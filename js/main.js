!(function (e) {
    ...
    t.on("load", function (a, o) {
        ...
        t.on("scroll", function () {
            ...
            e(r).length && e(r).owlCarousel({ items: 1, nav: !0, dots: !0, autoplay: true, loop: true, smartSpeed: 1e3, active: !0, navText: ["<i class='la la-angle-left'></i>", "<i class='la la-angle-right'></i>"] }),
            e(c).length &&
                e(c).owlCarousel({
                    loop: true,
                    items: 3,
            ...
            e(d).length && e(d).owlCarousel({ loop: !0, items: 1, nav: !1, dots: !0, smartSpeed: 500, autoplay: !0, margin: 15 }),
            e(u).length && e(u).owlCarousel({ loop: !0, items: 3, nav: !1, dots: !0, smartSpeed: 500, autoplay: !0, margin: 15, responsive: { 320: { items: 1 }, 768: { items: 2 }, 992: { items: 3 } } }),
            e(m).length &&
                e(m).owlCarousel({
                    loop: !0,
                    items: 5,
            ...
            e(v).length && e(v).owlCarousel({ loop: !0, items: 5, nav: !1, dots: !1, smartSpeed: 500, autoplay: !0, responsive: { 0: { items: 2 }, 481: { items: 3 }, 768: { items: 4 }, 992: { items: 5 } } }),
            e(h).length && e(h).owlCarousel({ loop: !0, items: 3, nav: !1, dots: !0, smartSpeed: 500, autoplay: !1, margin: 30, responsive: { 320: { items: 1 }, 992: { items: 3 } } }),
            e(w).length &&
                e(w).owlCarousel({
                    loop:true,
                    items: 5,
            ...
            e(k).length && e(k).owlCarousel({ loop: !0, items: 1, nav: !0, dots: !1, smartSpeed: 500, autoplay: !1, margin: 20, autoHeight: !0, navText: ["<i class='la la-arrow-left'></i>", "<i class='la la-arrow-right'></i>"] }),
            e(C).length &&
                e(C).owlCarousel({
                    loop: !0,
                    items: 3,
            ...
            e(T).length && e(T).dateDropper({ format: "d-m-Y", theme: "vanilla", large: !0, largeDefault: !0 }),
            ...
            e(f).length && e(f).selectpicker({ liveSearch: !0, liveSearchPlaceholder: "Search", liveSearchStyle: "contains", size: 5 }),
